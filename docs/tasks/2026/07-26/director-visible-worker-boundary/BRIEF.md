...
- Director 정본만 새 commit과 무결성으로 고정하고 생성 묶음을 제한 갱신했다. Windows 검증은 실행 비트 계약에 관련된 기존 세 실패만 남았으며 Linux 지속 통합 검사를 기다린다.

## 다음 행동

- 초안 PR을 게시하고 Linux 지속 통합 검사에서 묶음 무결성과 전체 단위 검사를 판단한다.
